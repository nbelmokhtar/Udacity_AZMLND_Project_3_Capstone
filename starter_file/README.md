...
The best performance was achieved by using Auto ML. AutoML is definitely better than HyperDrive in terms of architecture since we can create hundreds of models a day, get better model accuracy and deploy models faster. 

We registered the best model, created an inference config and deployed the model as a web service, by taking advantages of the files created. Below are the steps we took to deploy the model :
...
![Consume 01](https://github.com/nbelmokhtar/Udacity_AZMLND_Project_3_Capstone/blob/master/starter_file/screenshots/automl/006.PNG)
